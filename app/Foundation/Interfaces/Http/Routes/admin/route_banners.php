...
use App\Foundation\Interfaces\Http\Controllers\Admin\Banner\BannerFormController;
...
Route::middleware(['auth:admin_api'])->prefix('admin')->group(function () {
    ...
    Route::post('banners', [BannerFormController::class, 'store'])->name('admin.banners.store');
