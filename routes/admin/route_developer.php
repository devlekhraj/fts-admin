...
use App\Domains\Developer\Controllers\DeveloperController;
...
Route::middleware(['auth:admin_api'])->prefix('admin')->group(function () {
    ...
    Route::put('developer/api-keys/{id}', [DeveloperController::class, 'update'])->name('admin.developer.keyupdate');
