    ...
    <v-row>
      <v-col cols="12" lg="8" offset-lg="2">
        <div class="d-flex align-center justify-space-between mb-6">
          <div>
            <div class="text-h6">Product FAQs</div>
            <div class="text-body-2 text-medium-emphasis">FAQs attached to this product.</div>
          </div>
...
import { listProductFaqs, type FaqListItem } from '@/api/faqs.api';
...
async function fetchFaqs() {
  ...
  loading.value = true;
  try {
    const response = await listProductFaqs(id, { per_page: -1 });
