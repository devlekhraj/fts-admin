  ...
  <v-card-text class="py-6">
    ...
    <div class="mt-3 d-flex align-center justify-space-around py-6">
      <div style="width: max-content;" class="d-flex align-center">
        ...
        <div>
          <div class="font-weight-medium">Bulk delete selected products</div>
          <div class="text-medium-emphasis">{{ count }} product{{ count === 1 ? '' : 's' }} selected</div>
        </div>
      </div>
    </div>

    <div class="text-body-2 text-medium-emphasis text-center">
      This action will delete the selected products. Continue?
    </div>
  </v-card-text>
