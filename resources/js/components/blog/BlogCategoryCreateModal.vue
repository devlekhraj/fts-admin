...
import { ref } from 'vue';
import { create as createBlogCategory } from '@/api/blog-categories.api';
...
async function onSubmit() {
  ...
  try {
    ...
    const response = await createBlogCategory(payload);
    const message = (response as any)?.data?.message || 'Blog category created successfully.';
