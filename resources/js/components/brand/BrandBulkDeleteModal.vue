  ...
  <v-card-text class="py-6">
    ...
    <div class="mt-3 d-flex align-center justify-space-around py-6">
      <div style="width: max-content;" class="d-flex align-center">
        ...
        <div>
          <div class="font-weight-medium">Bulk delete selected brands</div>
          <div class="text-medium-emphasis">{{ count }} {{ count === 1 ? 'brand' : 'brands' }} selected</div>
        </div>
      </div>
    </div>

    <div class="text-body-2 text-medium-emphasis text-center">
      This action will soft delete the selected brands. Continue?
    </div>
  </v-card-text>
