<template>
  <BaseDetailTabImages :files="campaignFiles" usage-type="campaigns" :usage-id="item?.id ?? null"
    :edit-modal="CampaignImageEditModel" edit-modal-title="Edit Campaign Image" edit-button-text="Edit Image"
    ...
    <template #details="{ file }">
      <div class="d-flex align-center ga-2">
        ...
        <v-chip v-if="file.meta?.is_default" size="x-small" label color="success"
          class="text-uppercase font-weight-bold" style="border-radius: 4px;">Primary Image</v-chip>
      </div>
