      ...
      <div class="brand-top-grid">
        ...
        <div>
          ...
          <div class="d-flex align-center ga-2 mt-2">
            ...
            <v-btn v-if="brandUrl" :href="brandUrl" target="_blank" rel="noopener noreferrer" icon size="x-small"
    ...
    <v-card class="mt-4">
      ...
      <v-window v-model="activeTab">
        <v-window-item v-for="tab in tabItems" :key="tab.value" :value="tab.value">
          <component :is="tab.component" :item="brandDetail" :brand-id="brandId" @updated="fetchBrandDetail" />
        </v-window-item>
      </v-window>
    </v-card>
  </v-container>
