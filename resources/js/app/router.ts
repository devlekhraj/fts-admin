...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'emi-banks', name: 'admin.emi.banks', component: () => import('@/pages/EmiBankPage.vue'), meta: { title: 'EMI Banks' } },
      { path: 'emi-banks/:id', name: 'admin.emi.banks.detail', component: () => import('@/pages/EmiBankDetailPage.vue'), meta: { title: 'EMI Bank Detail' } },
      { path: 'emi-banks/:id/edit', name: 'admin.emi.banks.edit', component: () => import('@/pages/EmiBankEditPage.vue'), meta: { title: 'Edit EMI Bank' } },
      // blogs
